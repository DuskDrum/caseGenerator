...
func (s *FuncType) GetInstance() Parameter {
	return s
}

func (s *FuncType) GetZeroValue() Parameter {
	s.Value = nil
	return s
}
...
// ParseFuncType 解析ast
func ParseFuncType(expr *ast.FuncType, name string) *FuncType {
	ft := &FuncType{
		BasicParam: BasicParam{
			ParameterType: enum.PARAMETER_TYPE_FUNC_TYPE,
			Name:          name,
		},
	}
